...
GRAMMAR_DICTIONARY["table_alias"] = [
    ...
    '"airport_servicealias0"', '"airport_servicealias1"', '"airport_servicealias2"',
    '"airport_servicealias3"', '"airport_servicealias4"', '"airport_servicealias5"',
    '"airportalias0"', '"airportalias1"', '"airportalias2"', '"airportalias3"', '"cityalias0"',
    '"cityalias1"', '"cityalias2"', '"cityalias3"', '"cityalias4"', '"cityalias5"',
    '"class_of_servicealias0"', '"date_dayalias0"', '"date_dayalias1"', '"date_dayalias2"',
    '"date_dayalias3"', '"date_dayalias4"', '"daysalias0"', '"daysalias1"', '"daysalias2"',
    '"daysalias3"', '"daysalias4"', '"daysalias5"', '"daysalias6"', '"daysalias7"', '"daysalias8"',
    '"daysalias9"', '"equipment_sequencealias0"', '"equipment_sequencealias1"',
    '"equipment_sequencealias2"', '"fare_basisalias0"', '"fare_basisalias1"', '"fare_basisalias2"',
    '"fare_basisalias3"', '"fare_basisalias4"', '"fare_basisalias5"', '"farealias0"', '"farealias1"',
    '"farealias2"', '"farealias3"', '"farealias4"', '"flight_farealias0"', '"flight_farealias1"',
    '"flight_farealias2"', '"flight_farealias3"', '"flight_farealias4"', '"flight_legalias0"',
    '"flight_legalias1"', '"flight_stopalias0"', '"flight_stopalias1"', '"flightalias0"',
    '"flightalias1"', '"flightalias2"', '"flightalias3"', '"food_servicealias0"',
    '"food_servicealias1"', '"ground_servicealias0"', '"restrictionalias0"', '"statealias0"',
...
GRAMMAR_DICTIONARY["string"] = [
    ...
    '"\'atlanta\'"', '"\'b\'"', '"\'baltimore\'"', '"\'basic_type0\'"', '"\'bh\'"', '"\'bna\'"',
    '"\'boeing\'"', '"\'booking_class0\'"', '"\'bos\'"', '"\'boston\'"', '"\'breakfast\'"',
    '"\'bur\'"', '"\'burbank\'"', '"\'business\'"', '"\'bwi\'"', '"\'c\'"', '"\'california\'"',
    '"\'canadian airlines international\'"', '"\'canadian airlines\'"', '"\'charlotte\'"',
    '"\'chicago\'"', '"\'cincinnati\'"', '"\'city_name0\'"', '"\'city_name1\'"', '"\'city_name2\'"',
    '"\'city_name3\'"', '"\'class_type0\'"', '"\'class_type1\'"', '"\'cleveland\'"', '"\'co\'"',
    '"\'coach\'"', '"\'colorado\'"', '"\'columbus\'"', '"\'continental airlines\'"',
    '"\'country_name0\'"', '"\'cp\'"', '"\'cvg\'"', '"\'d/s\'"', '"\'d10\'"', '"\'d9s\'"',
    '"\'daily\'"', '"\'dal\'"', '"\'dallas fort worth\'"', '"\'dallas\'"', '"\'day_name0\'"',
    '"\'day_name1\'"', '"\'day_name2\'"', '"\'day_name3\'"', '"\'day_name4\'"', '"\'dc\'"',
    '"\'delta\'"', '"\'denver\'"', '"\'detroit\'"', '"\'dfw\'"', '"\'discounted0\'"', '"\'dl\'"',
    '"\'dtw\'"', '"\'ea\'"', '"\'economy0\'"', '"\'ewr\'"', '"\'f\'"', '"\'f28\'"',
    '"\'fare_basis_code0\'"', '"\'ff\'"', '"\'first\'"', '"\'florida\'"', '"\'fn\'"',
    ...
    '"\'meal_code0\'"', '"\'meal_code1\'"', '"\'meal_description0\'"', '"\'memphis\'"', '"\'mia\'"',
    ...
    '"\'round_trip_required0\'"', '"\'s\'"', '"\'s/\'"', '"\'sa\'"', '"\'salt lake city\'"',
    '"\'san diego\'"', '"\'san francisco\'"', '"\'san jose\'"', '"\'sd/d\'"', '"\'seattle\'"',
    '"\'sfo\'"', '"\'snack\'"', '"\'st. louis\'"', '"\'st. paul\'"', '"\'st. petersburg\'"',
    '"\'state_code0\'"', '"\'state_name0\'"', '"\'state_name1\'"', '"\'sunday\'"', '"\'tacoma\'"',
    '"\'tampa\'"', '"\'taxi\'"', '"\'tennessee\'"', '"\'thrift\'"', '"\'thursday\'"', '"\'toronto\'"',
    '"\'tpa\'"', '"\'transport_type0\'"', '"\'transport_type1\'"', '"\'turboprop\'"', '"\'tw\'"',
