...
from .seq2seq import Seq2seqModel, AttentionalLSTMDecoder
...
class CopySeq2seq(Seq2seqModel):
    ...
    def forward(self, input_seqs, input_lens, output_seqs, extend_art, extend_vsize, attent_mask):
        ...
        logit = self._decoder(
            ...
            init_dec_states, output_seqs
        )
        return logit

    def batch_decode(self, input_seqs, input_lens, extend_art, extend_vsize, attent_mask,
                     go, eos, unk, max_len):
    ...
    def decode(self, input_seqs, extend_art, extend_vsize, go, eos, unk, max_len):
        vsize = self._embedding.num_embeddings
